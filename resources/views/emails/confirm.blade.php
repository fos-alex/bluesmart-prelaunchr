        ...
        <td class="container" style="font-family:ArialMT, Arial;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;Margin:0 auto !important;">
            <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
                ...
                <table class="main" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;background:#fff;border-radius:3px;width:100%;">
                    ...
                    <tr>
                        <td class="wrapper" style="font-family:ArialMT, Arial;font-size:14px;vertical-align:top;box-sizing:border-box;padding:40px 80px;background-color:black;text-align:center;">
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                <tr>
                                    <td style="font-family:ArialMT, Arial;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:ArialMT, Arial;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;color:white;">Nearly there! To finish signing up, please click the button below to confirm that we have your email right or try pasting this link into the browser.</p>
                                        <a href="{{ route('auth.confirm', [ $token ]) }}" target="_blank" style="text-decoration:underline;cursor:pointer;">{{ route('auth.confirm', [ $token ]) }}</a>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                        ...
                        <tr>
                            <td style="font-family:ArialMT, Arial;font-size:14px;vertical-align:top;font-size:12px;text-align:center;color:black;margin-top:10px;margin-bottom:0;">
                                ...
                                <a href="https://www.facebook.com/bluesmartlabs/" target="_blank"><img class="social" src="{{ asset('img/email/icon_yt_1x.png') }}" /></a>
                            </td>
                        </tr>
                    </table>
                </div>
